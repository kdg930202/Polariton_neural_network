...
for t=1:length(T)
    ...
    H = H_R + H_I.*(t>=50).*(t<50+tau);
    K1 = -1i*(H*rho - rho*H) + 1i*gamma/2*(2*b1*rho*b1' - rho*b1'*b1 - b1'*b1*rho) ...
                             + 1i*gamma/2*(2*b2*rho*b2' - rho*b2'*b2 - b2'*b2*rho) ...
                             + 1i*P/2*(2*b1'*rho*b1 - rho*b1*b1' - b1*b1'*rho)...
                             + 1i*P/2*(2*b2'*rho*b2 - rho*b2*b2' - b2*b2'*rho);
    rho1 = rho + 0.5*dt*K1;
    K2 = -1i*(H*rho1 - rho1*H) + 1i*gamma/2*(2*b1*rho1*b1' - rho1*b1'*b1 - b1'*b1*rho1) ...
                               + 1i*gamma/2*(2*b2*rho1*b2' - rho1*b2'*b2 - b2'*b2*rho1) ...
                               + 1i*P/2*(2*b1'*rho1*b1 - rho1*b1*b1' - b1*b1'*rho1) ...
