...
for t=1:length(T)
    ...
    K1 = -1i*(H*rho - rho*H) + (W(1)*(A*rho*b1' - b1'*A*rho + b1*rho*A' - rho*A'*b1) ...
                             ...
                             + 1i*eta/(2*gamma)*(2*A*rho*A' - A'*A*rho - rho*A'*A)*(t>=time).*(t<time+tau) ...
    ...
    K2 = -1i*(H*rho1 - rho1*H) + (W(1)*(A*rho1*b1' - b1'*A*rho1 + b1*rho1*A' - rho1*A'*b1) ...
                               ...
                               + 1i*eta/(2*gamma)*(2*A*rho1*A' - A'*A*rho1 - rho1*A'*A)*(t>=time).*(t<time+tau) ...                              
    ...
    K3 = -1i*(H*rho2 - rho2*H) + (W(1)*(A*rho2*b1' - b1'*A*rho2 + b1*rho2*A' - rho2*A'*b1) ...
                               ...
                               + 1i*eta/(2*gamma)*(2*A*rho2*A' - A'*A*rho2 - rho2*A'*A)*(t>=time).*(t<time+tau) ...
    ...
    K4 = -1i*(H*rho3 - rho3*H) + (W(1)*(A*rho3*b1' - b1'*A*rho3 + b1*rho3*A' - rho3*A'*b1) ...
                               ...
                               + 1i*eta/(2*gamma)*(2*A*rho3*A' - A'*A*rho3 - rho3*A'*A)*(t>=time).*(t<time+tau) ...
